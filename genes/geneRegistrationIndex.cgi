...
#####################################################################################
# File Name: geneResistrationIndex.cgi												#
# Usage:		this script calls the geneRegistrationInput.shtml to display 
#                        the data input form										#
...
my $shtml_file="$WWW_path/genes/geneRegistrationInput.shtml";
