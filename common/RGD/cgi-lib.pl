...
# cgi-lib@pobox.com
# $Id: cgi-lib.pl,v 1.1.1.1 2002/07/19 22:33:53 rgddev Exp $
#
...
$cgi_lib'maxdata    = 1024*1024*25;    # maximum bytes to accept via POST - 2^17
...
$cgi_lib'bufsize  =  10240;    # default buffer size when reading multipart
